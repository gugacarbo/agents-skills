...
**Registry:** Read your task entry in `docs/jobs/0001-auth-middleware/super-plan.json` — it is your requirements. Look for `Task-A-1`.
...
**Report file:** Write your full report to `docs/jobs/0001-auth-middleware/Task-A-1/report.md`. Return only a one-line status to me.
