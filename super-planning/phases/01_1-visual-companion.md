...
```json
{
  ...
  "screen_dir": "/path/to/project/.super-planning/brainstorm/12345-1706000000/content",
  "state_dir": "/path/to/project/.super-planning/brainstorm/12345-1706000000/state"
}
```
