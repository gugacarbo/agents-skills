...
5. Evidência precede mutação; agente muta o próprio resultado e orquestrador
   muta decisão humana.
6. Em revisão de plano, confirme a mesma URL/ID do comentário canônico editado
   e um novo comentário curto de alterações; uma nova cópia integral é drift.
...
- Correção de plano edita o comentário canônico; não acumule planos completos.
