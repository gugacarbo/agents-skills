---
name: plan-writer
description: Produces one append-only code-toolbox implementation plan from an approved source set, issue scope, and repository evidence. Use in Phase 3; never review or implement the plan.
---
