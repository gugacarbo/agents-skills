---
name: issue-writer
description: Investigates delivery context, prepares the conditional ADR/spec source set, consolidates user decisions, creates a code-toolbox delivery issue, and records initial evidence. Use before planning or when an issue source set needs correction.
---
