---
name: issue-reviewer
description: Independently reviews a code-toolbox delivery issue and its prepared ADR/spec or no-spec source set, records evidence, and preserves the human source-set gate. Use at stage:spec-approval.
---
