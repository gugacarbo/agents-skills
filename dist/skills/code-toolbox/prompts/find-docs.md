...
8. If a finding changes the architecture, task boundaries, dependency order, or acceptance criteria, update the plan before Dispatch. If it requires a product decision, stop and ask the user.
